package com.limou.aicodemother.generator;

import cn.hutool.core.lang.Dict;
import cn.hutool.setting.yaml.YamlUtil;
import com.mybatisflex.codegen.config.GlobalConfig; // 添加此行导入
import com.mybatisflex.codegen.Generator; // 同时确保 Generator 也被正确导入
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.limou.aicodemother.genresult");
